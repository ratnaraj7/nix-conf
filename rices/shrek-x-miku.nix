    ...
    (defwidget other [icon high medium value]
      (box :orientation "horizontal"
          ...
          (label :text value
                :class "other_text")))
  '';
  hardlineSetupStringLua = ''
    -- comma separated options for hardline setup
    -- adding themes: https://github.com/ojroques/nvim-hardline/issues/21#issuecomment-877828890
